  ...
  /******/ [
    ...
    /***/ function (module, exports, __webpack_require__) {
      ...
      var PDFViewerApplication = {
                    ...
                    switch ((_context2.prev = _context2.next)) {
                      ...
                      case 6:
                        ...
                        if (
                          !(
                            name in OVERRIDES &&
                            _app_options.AppOptions.get(name) === OVERRIDES[name]
                          )
                        ) {
                          _context2.next = 10;
                          break;
                  ...
                  while (1) {
                    switch ((_context5.prev = _context5.next)) {
                      case 0:
                        ...
                        eventBus =
                          appConfig.eventBus || (0, _dom_events.getGlobalEventBus)(dispatchToDOM);
                        ...
                        this.pdfViewer = new _pdf_viewer.PDFViewer({
                          ...
                          renderInteractiveForms:
                            _app_options.AppOptions.get('renderInteractiveForms'),
                          enablePrintAutoRotate:
                            _app_options.AppOptions.get('enablePrintAutoRotate'),
        ...
        error: function error(message, moreInfo) {
          ...
          if (moreInfo) {
            moreInfoText.push(
              this.l10n.get('error_message', { message: moreInfo.message }, 'Message: {{message}}'),
            );
            if (moreInfo.stack) {
              moreInfoText.push(
                this.l10n.get('error_stack', { stack: moreInfo.stack }, 'Stack: {{stack}}'),
              );
            } else {
              if (moreInfo.filename) {
                moreInfoText.push(
                  this.l10n.get('error_file', { file: moreInfo.filename }, 'File: {{file}}'),
                );
              }
              if (moreInfo.lineNumber) {
                moreInfoText.push(
                  this.l10n.get('error_line', { line: moreInfo.lineNumber }, 'Line: {{line}}'),
                );
              }
            }
          }
                          ...
                          while (1) {
                            switch ((_context8.prev = _context8.next)) {
                              case 0:
                                ...
                                if (
                                  values.page &&
                                  _app_options.AppOptions.get('showPreviousViewOnLoad')
                                ) {
                                  hash =
                                    'page=' +
                                    values.page +
      ...
      var PDFCursorTools = (function () {
        function PDFCursorTools(_ref) {
          ...
          var container = _ref.container,
            ...
            cursorToolOnLoad =
              _ref$cursorToolOnLoad === undefined ? CursorTool.SELECT : _ref$cursorToolOnLoad;
            ...
            value: function render(_ref2) {
              var attachments = _ref2.attachments,
                ...
                keepRenderedCapability =
                  _ref2$keepRenderedCap === undefined ? false : _ref2$keepRenderedCap;
      ...
      var PDFFindController = (function () {
        function PDFFindController(_ref) {
          var linkService = _ref.linkService,
            ...
            eventBus =
              _ref$eventBus === undefined ? (0, _dom_events.getGlobalEventBus)() : _ref$eventBus;
    ...
    /***/ function (module, exports, __webpack_require__) {
      ...
      function isDestArraysEqual(firstDest, secondDest) {
        function isEntryEqual(first, second) {
          ...
          if (
            first !== null &&
            (typeof first === 'undefined' ? 'undefined' : _typeof(first)) === 'object' &&
            second !== null
          ) {
    ...
    /***/ function (module, exports, __webpack_require__) {
      ...
      function isValidExplicitDestination(dest) {
        ...
        if (
          !(
            (typeof zoom === 'undefined' ? 'undefined' : _typeof(zoom)) === 'object' &&
        ...
        function PDFThumbnailView(_ref) {
          var container = _ref.container,
            ...
            disableCanvasToImageConversion =
              _ref$disableCanvasToI === undefined ? false : _ref$disableCanvasToI,
            _ref$l10n = _ref.l10n,
            l10n = _ref$l10n === undefined ? _ui_utils.NullL10n : _ref$l10n;
            ...
            },
            {
              ...
              value: function _convertCanvasToImage() {
                ...
                if (this.disableCanvasToImageConversion) {
                  ...
                  this.l10n
                    .get('thumb_page_canvas', { page: this.pageId }, 'Thumbnail of Page {{page}}')
                    .then(function (msg) {
      ...
      var PDFViewer = (function (_BaseViewer) {
        ...
        function PDFViewer() {
          ...
          return _possibleConstructorReturn(
            this,
            (PDFViewer.__proto__ || Object.getPrototypeOf(PDFViewer)).apply(this, arguments),
          );
        }
                  ...
                  onePageRenderedCapability.promise.then(function () {
                    ...
                    var _loop = function _loop(_pageNum) {
                      pdfDocument.getPage(_pageNum).then(
                        ...
                        function (reason) {
                          console.error(
                            'Unable to get page ' + _pageNum + ' to initialize viewer',
                            reason,
                          );
                          if (--getPagesLeft === 0) {
                            pagesCapability.resolve();
      ...
      var AnnotationLayerBuilder = (function () {
        function AnnotationLayerBuilder(_ref) {
          var pageDiv = _ref.pageDiv,
            ...
            renderInteractiveForms =
              _ref$renderInteractiv === undefined ? false : _ref$renderInteractiv,
            _ref$l10n = _ref.l10n,
            l10n = _ref$l10n === undefined ? _ui_utils.NullL10n : _ref$l10n;
        ...
        function TextLayerBuilder(_ref) {
          var textLayerDiv = _ref.textLayerDiv,
            ...
            enhanceTextSelection =
              _ref$enhanceTextSelec === undefined ? false : _ref$enhanceTextSelec;
      ...
      var PDFSinglePageViewer = (function (_BaseViewer) {
        ...
        function PDFSinglePageViewer(options) {
          ...
          var _this = _possibleConstructorReturn(
            this,
            (PDFSinglePageViewer.__proto__ || Object.getPrototypeOf(PDFSinglePageViewer)).call(
              this,
              options,
            ),
          );
            ...
            value: function _updateUIState() {
              ...
              if (resetNumPages) {
                if (this.hasPageLabels) {
                  ...
                  this.l10n
                    .get('of_pages', { pagesCount: pagesCount }, 'of {{pagesCount}}')
                    .then(function (msg) {
    ...
    /***/ function (module, exports, __webpack_require__) {
      ...
      var GenericPreferences = (function (_BasePreferences) {
        ...
        function GenericPreferences() {
          ...
          return _possibleConstructorReturn(
            this,
            (GenericPreferences.__proto__ || Object.getPrototypeOf(GenericPreferences)).apply(
              this,
              arguments,
            ),
          );
    ...
    /***/ function (module, exports, __webpack_require__) {
      ...
      const dataURLtoFile = function (dataurl, filename, isBlob) {
      ...
      PDFPrintService.prototype = {
        ...
        useRenderedPage: function useRenderedPage(printItem) {
          ...
          // if ('toBlob' in scratchCanvas && !this.disableCreateObjectURL && _pdfjsLib.URL.createObjectURL) {
          ...
          // }
          if (_pdfjsLib.URL.createObjectURL(dataURLtoFile(scratchCanvas.toDataURL(), '', true))) {
            img.src = _pdfjsLib.URL.createObjectURL(
              dataURLtoFile(scratchCanvas.toDataURL(), '', true),
            );
            // img.src = scratchCanvas.toDataURL();
          } else {
            img.src = scratchCanvas.toDataURL();
